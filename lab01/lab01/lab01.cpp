// lab01.cpp : Определяет точку входа для приложения.
//
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hCursor = LoadCursorFromFile(L"my_cursor.cur");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        txt = { (rc.right - rc.left) / 2, (rc.bottom - rc.top) / 2, LPTSTR(L"Надпись") };
        break;
    }
    case WM_COMMAND:
    {
